...
<head>
  ...
  <style>
    ...
    #reportSection, #statisticsSection {
      display: none;
    }
    .sidebar-menu li a {
      display: flex;
      ...
      <aside class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
        ...
        <ul class="sidebar-menu nav flex-column">
          ...
          <li class="nav-item mt-5">
            <a href="/Quan_Ly_Su_Kien/app/views/TrangChu/trangchu.php" class="nav-link text-danger">
      ...
      $('#detailModal').on('show.bs.modal', function (event) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data.da_thanh_toan == 1) {
              $('#detail-payment-status').html('<span class="badge bg-success">Đã thanh toán</span>');
            } else {
              $('#detail-payment-status').html('<span class="badge bg-warning text-dark">Chưa thanh toán</span>');
            }
